...
All commands habe been tried in Powershell. With cmd or git bash you might run into problems. The make command will not work on Windows. Thus you have to run the command to build the image directly.
